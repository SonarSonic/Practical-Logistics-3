...
/*
import sonar.logistics.server.data.api.IDataCombinable;
import sonar.logistics.server.data.api.IDataFactory;
import sonar.logistics.server.data.api.IDataWatcher;
import sonar.logistics.server.data.OLD.sources.IDataMultiSource;
...
public class DataHolderMultiSource<D extends IDataCombinable> extends DataHolder implements IDataWatcher {
    ...
    public boolean canUpdateData() {
        return forceUpdate || (dataChanged && !dataWatchers.isEmpty() && ticks == tickRate);
    }

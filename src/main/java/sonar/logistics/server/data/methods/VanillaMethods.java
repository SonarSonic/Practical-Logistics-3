...
public class VanillaMethods {
    ...
    public static void init(){
        ...
        */
        BLOCK_TRANSLATION_KEY = Registries.getMethodRegistry().registerBlockMethod(MethodCategory.BLOCKS,"getTranslationKey", String.class, Block.class, (E, B) -> B.getTranslationKey());
        ...
        BLOCK_POS_X = Registries.getMethodRegistry().registerBlockMethod(MethodCategory.BLOCKS,"getX", Integer.class, Block.class, (E, B) -> E.pos().getX());
        BLOCK_POS_Y = Registries.getMethodRegistry().registerBlockMethod(MethodCategory.BLOCKS,"getY", Integer.class, Block.class, (E, B) -> E.pos().getY());
        BLOCK_POS_Z = Registries.getMethodRegistry().registerBlockMethod(MethodCategory.BLOCKS,"getZ", Integer.class, Block.class, (E, B) -> E.pos().getZ());
        BLOCK_FACE = Registries.getMethodRegistry().registerBlockMethod(MethodCategory.BLOCKS,"getFace", String.class, Block.class, (E, B) -> E.face().name());
        BLOCK_HARDNESS = Registries.getMethodRegistry().registerBlockMethod( MethodCategory.BLOCKS,"getBlockHardness", Float.class, Block.class, (E, B) -> E.state().getBlockHardness(E.world(), E.pos()));
        BLOCK_HARVEST_LEVEL = Registries.getMethodRegistry().registerBlockMethod( MethodCategory.BLOCKS,"getHarvestLevel", Integer.class, Block.class, (E, B) -> B.getHarvestLevel(E.state()));
        BLOCK_IS_FOLIAGE = Registries.getMethodRegistry().registerBlockMethod( MethodCategory.BLOCKS,"isFoliage", Boolean.class, Block.class, (E, B) -> B.isFoliage(E.state(), E.world(), E.pos()));
        ...
        BLOCK_WEAK_POWER = Registries.getMethodRegistry().registerBlockMethod( MethodCategory.BLOCKS,"getWeakPower", Integer.class, Block.class, (E, B) -> E.state().getWeakPower(E.world(), E.pos(), E.face()));
        BLOCK_STRONG_POWER = Registries.getMethodRegistry().registerBlockMethod( MethodCategory.BLOCKS,"getStrongPower", Integer.class, Block.class, (E, B) -> E.state().getStrongPower(E.world(), E.pos(), E.face()));
        ...
        BLOCK_IS_MAX_AGE = Registries.getMethodRegistry().registerBlockMethod( MethodCategory.BLOCKS,"isMaxAge", Boolean.class, CropsBlock.class, (E, B) -> B.isMaxAge(E.state()));
        ...
        WORLD_IS_RAINING = Registries.getMethodRegistry().registerWorldMethod( MethodCategory.WORLD,"isRaining", Boolean.class, W -> W.getWorldInfo().isRaining());
        WORLD_IS_THUNDERING = Registries.getMethodRegistry().registerWorldMethod( MethodCategory.WORLD,"isThundering", Boolean.class, W -> W.getWorldInfo().isThundering());
        WORLD_NAME = Registries.getMethodRegistry().registerWorldMethod( MethodCategory.WORLD,"getWorldName", String.class, W -> W.getWorldInfo().getWorldName());
        WORLD_DIMENSION = Registries.getMethodRegistry().registerWorldMethod(MethodCategory.WORLD,"getDimension", Integer.class, W -> W.getDimension().getType().getId());
        WORLD_DIMENSION_NAME = Registries.getMethodRegistry().registerWorldMethod(MethodCategory.WORLD,"getName", String.class, W ->  W.getDimension().getType().getRegistryName().getPath());

        ENTITY_POS_X = Registries.getMethodRegistry().registerEntityMethod(MethodCategory.ENTITIES,"getX", Integer.class, Entity.class, (E, B) -> B.getPosition().getX());
        ENTITY_POS_Y = Registries.getMethodRegistry().registerEntityMethod(MethodCategory.ENTITIES,"getY", Integer.class, Entity.class, (E, B) -> B.getPosition().getY());
        ENTITY_POS_Z = Registries.getMethodRegistry().registerEntityMethod(MethodCategory.ENTITIES,"getZ", Integer.class, Entity.class, (E, B) -> B.getPosition().getZ());
        ENTITY_NAME = Registries.getMethodRegistry().registerEntityMethod(MethodCategory.ENTITIES,"getName", String.class, Entity.class, (E, B) -> B.getName().getString());
        ENTITY_HEALTH = Registries.getMethodRegistry().registerEntityMethod(MethodCategory.ENTITIES,"getHealth", Float.class, LivingEntity.class, (E, B) -> B.getHealth());
        ENTITY_MAX_HEALTH = Registries.getMethodRegistry().registerEntityMethod(MethodCategory.ENTITIES,"getMaxHealth", Float.class, LivingEntity.class, (E, B) -> B.getMaxHealth());
        ENTITY_TOTAL_ARMOR = Registries.getMethodRegistry().registerEntityMethod(MethodCategory.ENTITIES,"getTotalArmorValue", Integer.class, LivingEntity.class, (E, B) -> B.getTotalArmorValue());

        PLAYER_IS_CREATIVE = Registries.getMethodRegistry().registerEntityMethod(MethodCategory.ENTITIES,"isCreative", Boolean.class, ServerPlayerEntity.class, (E, P) -> P.isCreative());
        PLAYER_IS_SPECTATOR = Registries.getMethodRegistry().registerEntityMethod(MethodCategory.ENTITIES,"isSpectator", Boolean.class, ServerPlayerEntity.class, (E, P) -> P.isSpectator());
        PLAYER_FOOD_LEVEL = Registries.getMethodRegistry().registerEntityMethod(MethodCategory.ENTITIES,"getFoodStats", Integer.class, ServerPlayerEntity.class, (E, P) -> P.getFoodStats().getFoodLevel());
        PLAYER_SATURATION_LEVEL = Registries.getMethodRegistry().registerEntityMethod(MethodCategory.ENTITIES,"getFoodStats", Float.class, ServerPlayerEntity.class, (E, P) -> P.getFoodStats().getSaturationLevel());

        ADDRESS_DATA = Registries.getMethodRegistry().registerMethod(MethodCategory.NETWORK, "getSourceAddress", SourceData.class, (E) -> true, SourceData::fromEnvironment);

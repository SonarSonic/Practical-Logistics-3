...
import sonar.logistics.server.data.api.categories.DataCategories;
...
public class VanillaMethods {
    ...
    public static IMethod<String> BLOCK_TRANSLATION_KEY;
    ...
    public static IMethod<IItemHandler> ITEM_CAPABILITY;
    ...
    public static void init(){
        ...
        */
        BLOCK_TRANSLATION_KEY = MethodRegistry.registerMethodBlock(DataCategories.BLOCKS,"getTranslationKey", String.class, Block.class, (E, B) -> B.getTranslationKey());
        ...
        */
        ...
        WORLD_DIMENSION = MethodRegistry.registerMethodWorld(DataCategories.WORLD,"getDimension", Integer.class, W -> W.getDimension().getType().getId());
        WORLD_DIMENSION_NAME = MethodRegistry.registerMethodWorld(DataCategories.WORLD,"getName", String.class, W ->  W.getDimension().getType().getRegistryName().getPath());
        ...
        ENTITY_NAME = MethodRegistry.registerMethodEntity(DataCategories.ENTITIES,"getName", String.class, Entity.class, (E, B) -> B.getName().getString());
        ENTITY_HEALTH = MethodRegistry.registerMethodEntity(DataCategories.ENTITIES,"getHealth", Float.class, LivingEntity.class, (E, B) -> B.getHealth());
        ENTITY_MAX_HEALTH = MethodRegistry.registerMethodEntity(DataCategories.ENTITIES,"getMaxHealth", Float.class, LivingEntity.class, (E, B) -> B.getMaxHealth());
        ENTITY_TOTAL_ARMOR = MethodRegistry.registerMethodEntity(DataCategories.ENTITIES,"getTotalArmorValue", Integer.class, LivingEntity.class, (E, B) -> B.getTotalArmorValue());

        PLAYER_IS_CREATIVE = MethodRegistry.registerMethodEntity(DataCategories.ENTITIES,"isCreative", Boolean.class, ServerPlayerEntity.class, (E, P) -> P.isCreative());
        PLAYER_IS_SPECTATOR = MethodRegistry.registerMethodEntity(DataCategories.ENTITIES,"isSpectator", Boolean.class, ServerPlayerEntity.class, (E, P) -> P.isSpectator());
        PLAYER_FOOD_LEVEL = MethodRegistry.registerMethodEntity(DataCategories.ENTITIES,"getFoodStats", Integer.class, ServerPlayerEntity.class, (E, P) -> P.getFoodStats().getFoodLevel());
        PLAYER_SATURATION_LEVEL = MethodRegistry.registerMethodEntity(DataCategories.ENTITIES,"getFoodStats", Float.class, ServerPlayerEntity.class, (E, P) -> P.getFoodStats().getSaturationLevel());

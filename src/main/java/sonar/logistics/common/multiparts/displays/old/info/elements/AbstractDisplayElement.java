...
public abstract class AbstractDisplayElement implements IDisplayElement {
	...
	protected ElementAlignment width_align = ElementAlignment.CENTERED;
	...
	@Override
	public ElementAlignment getWidthAlignment() {
		return width_align;
	}

	@Override
	public ElementAlignment setWidthAlignment(ElementAlignment align) {

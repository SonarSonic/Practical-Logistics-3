...
public class GSIRenderTypes extends RenderType {
    ...
    ///diffuse lighting prevents rects being their true colour, hence this version with it disabled.
    public static RenderType getTranslucentCullNoDiffuse(ResourceLocation loc) {
        ...
        return makeType("pl3_translucent_cull_no_diffuse", DefaultVertexFormats.ENTITY, 7, 256, true, true, lvt_1_1_);
    }

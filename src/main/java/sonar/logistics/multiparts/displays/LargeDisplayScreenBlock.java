...
public class LargeDisplayScreenBlock extends OrientatedMultipart implements IMultipartBlock {
    ...
    public MultipartTile createMultipartTile(MultipartEntry entry){
        return new DisplayScreenTile(entry, PL3Shapes.LARGE_DISPLAY_SCREEN_SCALING);
    }
